...
btn_admin_panel_stats = Статистика 📊
btn_admin_panel_stats_callback_event = Событие обратного вызова 🎆
btn_admin_panel_stats_state_event = Событие состояния 🎇
...
btn_hide_title = Скрыть ❎
btn_image_title = Изображение 🖼
...
admin_panel_stats_message_title = Статистика 📊
admin_panel_stats_message_subtitle = Выберите, какие статистические данные необходимо вывести, нажмите на кнопки для вывода в соответствующем формате
admin_panel_stats_message_options = Варианты
admin_panel_stats_message_selection_error = Вы не выбрали ни одной опции для отображения статистики
admin_panel_stats_message_formation_process = В процессе формирования
admin_panel_stats_message_callback_event = Событие обратного вызова
admin_panel_stats_message_state_event = Событие состояния
